    ...
    <form action={{route("user.store")}} method="post">
        ...
        <div id="user_inputs">
            ...
            <div class="form-group">
                ...
                <input type="date" @if(!empty($user)) value="{{{$user->birth_date}}}" @endif class="form-control"
            ...
            <div class="form-group">
                ...
                <input type="email" @if(!empty($user)) value="{{{$user->personal_email}}}" @endif class="form-control"
            ...
            <div class="form-group">
                ...
                <input type="text" @if(!empty($user)) value="{{{$user->position}}}" @endif class="form-control"
                       id="cargo"
