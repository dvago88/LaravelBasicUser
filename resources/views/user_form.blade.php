...
@section("content")
    <form action="/user" method="post">
         ...
         <div class="form-group">
             ...
             <input type="text" class="form-control" id="nivel_acceso" name="nivel_acceso" placeholder="Nivel De Acceso">
         </div>
         <div class="form-check">
             <input class="form-check-input" type="radio" name="activo" id="activo" value="activo" checked>
